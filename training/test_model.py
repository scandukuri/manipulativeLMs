...
# alpaca model
model = LlamaForCausalLM.from_pretrained('/scr/jphilipp/manipulativeLM-nodecontents/alpaca_7b', cache_dir='/scr/jphilipp/manipulativeLM-nodecontents',  load_in_8bit=True)
# llama tokenizer
tokenizer = LlamaTokenizer.from_pretrained('/scr/jphilipp/manipulativeLM-nodecontents/7B', cache_dir='/scr/jphilipp/manipulativeLM-nodecontents', load_in_8bit=True)
